...
function atw_slider_save_slider_options() {
    ...
    // **** text values
    $text_opts = array (
        'selected_slider_filter', 'content_type', 'slider_type', 'easing', 'imageSize',
    ...
    $check_opts = array (
        ...
        'fullWidthImages', 'addImageBorder', 'no_pauseOnAction', 'no_pauseOnHover',  'directionVertical', 'titleOverlay',
         'slidingAbove', 'noDimThumbs', 'inlineLink', 'topNavArrows', 'alwaysShowArrows', 'disableArrowSlide', 'scriptsAtTop'
    );
...
<?php
    ...
    atw_posts_slider_checkbox( 'pausePlay', '+Show pause/play button. (Using this option automatically disables auto pause on hover over slider.)');
    ...
    atw_posts_slider_val( 'slideMargin', 'Border width around Slider; space between Carousel slides (Defaults: Posts=15px, Images=5px; Vertical Scrolling: 0px)', 'px' );
