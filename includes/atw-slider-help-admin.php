...
<ol>
  ...
  <li>Open the<em> Dashboard : Weaver Posts/Slider : Sliders</em> tab. Create a New Slider (e.g., named &quot;Colorado&quot;). In the &quot;Required Options&quot; section, set slider type and paging options  to your choice.  In the <span style="color:green;">&quot;Quick Option:</span> Slider Post Slug" box right under the&quot;Slider Filter:" setting, enter the slug (e.g., &quot;colorado&quot;) of the Slider Post you created in step 1. Save settings.</li>
  ...
  <li>Click to see the <a href="//weavertheme.com/plugins/plugin-tutorials/tutorial-create-image-slideshow/" target="_blank">live tutorial</a>
...
<ol>
  ...
  <li>Click to see the <a href="//weavertheme.com/plugins/plugin-tutorials/tutorial-create-posts-slideshow/" target="_blank">live tutorial</a>
